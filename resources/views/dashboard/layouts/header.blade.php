<header class="antialiased sticky top-0 left-0 z-30">
    <nav class="bg-hero border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-slate-900">
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar"
                    aria-controls="default-sidebar" type="button"
                    class="inline-flex items-center p-2 mt-2 text-sm text-cyan-500 rounded-lg md:hidden">
            ...
            <div class="flex items-center lg:order-2">
                <form action="/logout" method="post" class="hidden lg:block">
                    @csrf
                    <button
                ...
                <label class="relative ml-3 inline-flex items-center cursor-pointer">
                    <span class="mr-3 text-yellow-300 dark:text-slate-900"><svg xmlns="http://www.w3.org/2000/svg"
                            width="20" height="20" fill="currentColor" class="bi bi-brightness-high-fill"
                            viewBox="0 0 16 16">
                            <path
                    ...
                    <span class="ml-3 text-[#e6faf4] dark:text-white"><svg xmlns="http://www.w3.org/2000/svg"
