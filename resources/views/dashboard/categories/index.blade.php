...
@section('container')
    <div
        ...
        <h1 class="h2 text-gray-900 dark:text-white">Post Categories</h1>
    </div>
    <!-- Start block -->
        ...
        <div class="mx-auto max-w-screen-2xl px-4 lg:px-12 dark:bg-slate-800">
            ...
            <div
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:bg-gray-800">
                        <thead class="text-xs text-gray-900 uppercase bg-cyan-50 dark:bg-gray-700">
                            <tr>
                                <th scope="col" class="p-4 dark:text-white">#</th>
                                <th scope="col" class="p-4 dark:text-white">Category Name</th>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete
                        this posts?</h3>
                    <form action="/dashboard/categories/{{ $category->slug }}" method="post" class="inline-flex">
                        @method('delete')
                        @csrf
